...
public class NokiaAppOptionsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (dialog.getWindow() != null) {
            ...
            // 清除 FLAG_NOT_FOCUSABLE，确保 Dialog 首次 show 就能接收按键事件
        ...
        // 修复 Bug 1：Dialog 首次 show 后 Window 焦点未就绪，第一个方向键被系统焦点路由吞掉。
        // 用 post 延迟到 layout 完成后 requestFocus，确保按键直达 Dialog 的 onKeyListener。
